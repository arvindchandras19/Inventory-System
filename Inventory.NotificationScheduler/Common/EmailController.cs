...
namespace Inventory.NotificationScheduler.Common
{
    public class EmailController
    {
        ...
        public void SendEmailTransferOut(String FromEmailid, String ToEmailid, String Content, String subject)
        {
            try
            {
                ...
                string senderID = objXmlConfig.SMTPSenderEmail;
                string senderPassword = objXmlConfig.SMTPSenderPwd;
                string SMTPServer = objXmlConfig.SMTPServer;
                string SMTPSSL = objXmlConfig.SMTPSSL;
                string SMTPPort = objXmlConfig.SMTPPort;
