<%@ Page Title="Generate/Approve-Major Items" Language="C#" MasterPageFile="~/Inven.Master" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CapitalOrder.aspx.cs" Inherits="Inventory.CapitalOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //        };
        //        var val = $(this).val() || [];
        //        if (obj.length = 1 && items == 0 && objName[0] == "All") {
        //            $this[0].sumo.selectAll();
        //        } else if (parseInt(val.length) != 1 && objName[0] != "All") {
    ...
    <script type="text/javascript">
        ...
        //            alert('Multiple selection are not allowed here. Use Multi select link for multiple selection.');
        //            $this[0].sumo.unSelectAll();
        //            //$('[id*=drpfacilitysearch]')[0].sumo.unSelectItem(i);
        //        } else if (parseInt(val.length) > 1) {
    ...
    <script type="text/javascript">
        function GetgrdOrderSearchIndexValue(orderid) {
            ...
            grdCapitalIndex = row.rowIndex - 1;
            document.getElementById('<%=HddDetailsID.ClientID%>').value += (grdCapitalIndex) + ',';
            console.log(grdCapitalIndex);
        }
        //function LoadScript() {
        //    $(document).ready(function () {
        //        $('[id*=grdCRRequestPO] tr').each(function () {
        //            var lblAction = $('.lblAction', this).text();
        //            var drpaction = $('.drpaction', this);

        //            var array = lblAction.split(",");
        //            drpaction.empty();
        //            drpaction.append($("<option>", "</option>").text('--Select Action--'));
        //            $.each(array, function (i) {
        //                if (array[i] != '')
        //                    drpaction.append($("<option></option>").attr("value", array[i]).text(array[i]))
        //                //console.log(array[i]);
        //            });
        //        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <asp:UpdatePanel ID="updmain" runat="server">
            <ContentTemplate>
                <script type="text/javascript">
                    //Sys.Application.add_load(drpco);
                ...
                <div id="DivCapitalorder" runat="server" class="mypanel-body" style="padding: 5px 15px 15px 15px;">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:ListBox ID="drpcorsearch" runat="server" CssClass="form-control" SelectionMode="Multiple" multiple="multiple" OnSelectedIndexChanged="drpcorsearch_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>  
                        ...
                        <div style="margin-left: 1px; margin-top: 3px;" id="divsearch">
                            <div class="row">
                                ...
                                <div class="col-lg-9" align="right">
                                    ...
                                    <asp:Button ID="btnapproveall" runat="server" CssClass="btn btn-primary" ValidationGroup="EmptyFieldSave" Text="Approve All" OnClick="btnapproveall_Click" />
                                    ...
                                    <asp:Button ID="btnCoreview" runat="server" Text="Review" CssClass="btn btn-primary" OnClick="btnCoreview_Click" />
                                    <asp:Button ID="btnclear" runat="server" Text="Clear All" CssClass="btn btn-primary" Visible="false" />
                                </div>
                            </div>
                              <asp:Label ID="lblrcount" runat="server">No of records : <%=grdCRRequestPO.Rows.Count.ToString() %></asp:Label>
                            <div class="MPRSearchgrid">
                                <asp:GridView ID="grdCRRequestPO" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive" OnRowDataBound="grdCRRequestPO_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CPRNo">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbCRrno" runat="server" Text='<%# Eval("CRNo")%>' OnClick="lbCRrno_Click"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Action" HeaderStyle-Width="11%">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="drpaction" runat="server" CssClass="form-control drpaction" onchange="GetgrdOrderSearchIndexValue(this)"></asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content ">
                            <div class="modal-header bg-green">
                                <h4 class="modal-title font-bold text-white">Major Item Order
                ...
                <div style="display: none">
                    <rsweb:ReportViewer ID="rvCRPOreport" runat="server"></rsweb:ReportViewer>
                </div>
                <div style="display: none">
                    <rsweb:ReportViewer ID="rvCRreportPDF" runat="server"></rsweb:ReportViewer>
                </div>
                    ...
                    <div class="modal-dialog-Review">
                        <div class="modal-content">
                            <div class="modal-header" style="padding: 8px 5px 0px 5px;">
                                ...
                                <h4 class="modal-title" style="color: green; font-size: large">Major Item Order Review</h4>
                            </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="row" style="margin-bottom: 2px;">
                                        ...
                                        <div class="col-lg-6" align="right">
                                            <asp:Button ID="btnGenerateOrder" runat="server" CssClass="btn btn-success" Text="Generate\Approve Order" ValidationGroup="Empty Field" OnClientClick="Hide(this)" OnClick="btnGenerateOrder_Click" />
                                            <asp:Button ID="btnrevwcancel" runat="server" CssClass="btn btn-primary" Text="Cancel" OnClick="btnrevwcancel_Click" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                              <asp:Label ID="lblrcount2" runat="server">No of records : <%=grdreviewreqpo.Rows.Count.ToString() %></asp:Label>
                                                ...
                                                <asp:GridView ID="grdreviewreqpo" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive" OnRowDataBound="grdreviewreqpo_RowDataBound">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Print" HeaderStyle-Width="4%" ItemStyle-Width="4%">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgreviewprint" runat="server" Text="Edit" Height="20px" ImageUrl="~/Images/Print.png" OnClick="imgreviewprint_Click" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="CapitalItemMasterID" HeaderText="CapitalItemMasterID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide" />
                                                        ...
                                                        <asp:TemplateField HeaderText="CPRNo">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lblreviewCRrno" runat="server" Text='<%# Eval("CRNo")%>' OnClick="lblreviewCRrno_Click"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="CPONO">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lblreviewcrono" runat="server" Text='<%# Eval("CPONo")%>' OnClick="lblreviewcrono_Click"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="TotalCost" HeaderText="Price($)" HeaderStyle-Width="9%" ItemStyle-Width="9%" />
                                                        <asp:BoundField DataField="Status" HeaderText="Status" HeaderStyle-Width="9%" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtremarks" runat="server" Visible="false" TextMode="MultiLine" Text='<%# Eval("Remarks")%>'></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="rfvRemarks" ValidationGroup="Empty Field" ControlToValidate="txtremarks" runat="server"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding: 5px;">
                                <div class="form-horizontal">
                                    <div class="row" style="margin-bottom: 2px;">
                                        <div class="col-lg-3" align="left">
                                            <asp:Label ID="lblheader" runat="server" CssClass="page-header page-title" Text="Header"></asp:Label>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-4 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:Label ID="lblcorporate" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col-md-4 col-lg-4">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="SRReviewgrid">
                                                <asp:GridView ID="grdreview" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" ShowFooter="true" CssClass="table table-responsive">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="CapitalItemMasterID" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbCRMasterID" runat="server" Text='<%# Eval("CapitalItemMasterID") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Equipment Category">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblequrecat" runat="server" Text='<%# Eval("EquipmentSubCategory") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Equipment List">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblequrelst" runat="server" Text='<%# Eval("EquipementList") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Price per Qty ($)" HeaderStyle-Width="11%">
                                                            <ItemTemplate>
                                                                <span>$</span>
                                                                <asp:Label ID="lblrevppqty" runat="server" Text='<%# Eval("PricePerUnit","{0:F2}") %>'></asp:Label>
                                                            </ItemTemplate>
                                                              <FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Price ($)">
                                                            ...
                                                            <FooterTemplate>
                                                                ...
                                                                <asp:Label ID="lblshippingcost" runat="server" Text='<%# Eval("ShippingCost", "{0:F2}") %>' ForeColor="Black"></asp:Label><br />
                                                                <span style="color: black">$</span>
                                                                <asp:Label ID="lbltax" runat="server" Text='<%# Eval("Tax", "{0:F2}") %>' ForeColor="Black"></asp:Label><br />
                                                                <br />
                                                                <span style="color: black">$</span>
                                                                <asp:Label ID="lbltotalcost" runat="server" Text='<%# Eval("TotalCost", "{0:F2}") %>' ForeColor="Black"></asp:Label>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <HeaderStyle CssClass="Headerstyle" />
